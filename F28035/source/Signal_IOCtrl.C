...
#define   K32_PFC_ON_CHECK_INTERVAL hptsc_UsToTicks(100)
#define   K16_PFCOK_OFF_T     200
#define   K16_PFC_ON_T     200
...
void IO_UpdInput_PFCOK(void)
{
	...
	static HptscTicks_t ts_PFC_ON_CHECK = 0;
	if ( hptsc_IsElapsedRepetitive ( &ts_PFC_ON_CHECK, K32_PFC_ON_CHECK_INTERVAL ) )
	{
