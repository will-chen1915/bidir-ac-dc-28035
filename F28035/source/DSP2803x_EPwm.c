...
//	EPwm1Regs.TZCLR.all = 0x0007;					//clear all TZFLAG
	...
	EPwm1Regs.DCTRIPSEL.bit.DCAHCOMPSEL = DC_COMP2OUT;        // DCAH = Comparator 1 output
...
//	EPwm2Regs.TZCLR.all = 0x0007;					//clear all TZFLAG
	...
	EPwm2Regs.TBPRD = DC_DC_FREQUENCY;
...
void InitEPWM3 ( void )
{
	...
	EPwm3Regs.TBPRD = DC_DC_FREQUENCY;
...
//	EPwm4Regs.TZSEL.bit.OSHT1 = TZ_ENABLE;			//Enable TZ1 as a OST trip source
//	EPwm4Regs.TZSEL.bit.OSHT2 = TZ_ENABLE;			//Enable TZ2 as a OST trip source
//	EPwm4Regs.TZSEL.bit.OSHT3 = TZ_ENABLE;			//Enable TZ3 as a OST trip source
	EPwm4Regs.TZCTL.bit.TZA = TZ_FORCE_LO;
...
//	EPwm4Regs.TZCLR.all = 0x0007;					//clear all TZFLAG
	...
	// Define an event (DCAEVT2) for Current CBC
	EPwm4Regs.DCTRIPSEL.bit.DCAHCOMPSEL = DC_COMP2OUT;		  // DCAH = Comparator 1 output
...
//	EPwm2Regs.TZEINT.bit.DCBEVT2=ET_ENABLE;
	...
	EPwm4Regs.TBPRD = DC_DC_FREQUENCY;
	...
	EPwm4Regs.CMPA.half.CMPA = DC_DC_FREQUENCY - INITIAL_DUTY;
...
//	EPwm5Regs.TZSEL.bit.OSHT3 = TZ_ENABLE;			//Enable TZ3 as a OST trip source
	...
	EPwm5Regs.TZCTL.bit.DCBEVT2 = TZ_FORCE_LO;			// set EPWMxB to low at fault
...
//	EPwm5Regs.TZEINT.bit.DCAEVT2=ET_ENABLE;
//	EPwm5Regs.TZEINT.bit.DCBEVT2=ET_ENABLE;
#endif
	...
	EPwm5Regs.TBPRD = DC_DC_FREQUENCY;
...
//	EPwm5Regs.ETPS.bit.INTPRD = ET_1ST;				//Generate INT on 1st event
	...
	EPwm5Regs.CMPA.half.CMPA = DC_DC_FREQUENCY;
//	EPwm5Regs.CMPA.half.CMPA = INITIAL_DUTY;
	EPwm5Regs.CMPB = 0;
...
//	EPwm6Regs.TZSEL.bit.OSHT3 = TZ_ENABLE;			//Enable TZ3 as a OST trip source
	...
	EPwm6Regs.TZCTL.bit.DCBEVT2 = TZ_FORCE_LO;			// set EPWMxB to low at fault
...
//	EPwm6Regs.TZEINT.bit.DCAEVT2=ET_ENABLE;
//	EPwm6Regs.TZEINT.bit.DCBEVT2=ET_ENABLE;
	...
	EPwm6Regs.TBPRD = DC_DC_FREQUENCY;
...
//	EPwm6Regs.CMPA.half.CMPA = DC_DC_FREQUENCY - INITIAL_DUTY;
