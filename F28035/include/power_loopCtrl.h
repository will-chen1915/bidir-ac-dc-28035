...
//#define INITIAL_DUTY            DUTY(20)
#define INITIAL_DUTY            DUTY(0)//DUTY(40)		//0~50  ------>0~100%
#define MAX_DUTY                DUTY(44)//352
...
#define K16_LVOLT_RISETIME      T0_ms(350.0)//do not over 400ms, or it should not use this way to softsart
...
extern void set_MaxDuty(Uint16 u16SetValue);
